...
#+begin_src emacs-lisp
  (use-package dashboard
    ...
    (dashboard-items '((bookmarks . 12)  ; show 12 bookmarks
                       ...
                       (agenda    . 12))); show 12 agenda items
    ...
    (dashboard-item-names '(("Agenda for today:"           . "Agenda (today):")
    ...
    (defun my/dashboard-denote-shortener ()
      ...
      (let ((file (buffer-file-name)))
        (if (and file (string-match "--\\([a-z0-9-]+\\)" file))
            (format "%-24.24s: " (match-string 1 file)) ;; Show 10 chars of the title
          (format "%-24.24s: " (or (org-get-category) "")))))
    (setq dashboard-agenda-prefix-format " %i %(my/dashboard-denote-shortener)")
