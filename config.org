...
#+end_src
** transient-posframe
Load transient-posframe to show transients in a posframe as per instructions on
https://github.com/yanghaoxie/transient-posframe
#+begin_src emacs-lisp
  (use-package transient-posframe
    :straight (:host github :repo "tarsiiformes/transient-posframe" :branch "fix-sizing" :files ("*.el"))
    :init
