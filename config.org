...
#+end_src
*** customize functions to use content of active region as initial input for minibuffer
...
#+end_src
*** customize functions to copy the last minibuffer message to kill ring
customized functions:
- ~pwd~
  #+begin_src emacs-lisp
